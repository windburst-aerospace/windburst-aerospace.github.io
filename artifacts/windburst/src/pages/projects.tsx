...
const projects: Project[] = [
  ...
  {
    id: "lre-800",
    name: "Prototype of the liquid rocket",
    subtitle: "High-Power liquid Rocket",
    status: "PLANNING",
      ...
      <section className="pt-32 md:pt-44 pb-16 md:pb-24 relative">
        ...
        <div className="container mx-auto px-5 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.h1
              variants={slideUp}
              className="text-5xl md:text-8xl font-bold tracking-tighter mb-5 leading-[0.9]"
            >
              UPCOMING
              <br />
            ...
            <motion.p
              variants={slideUp}
              className="font-mono text-muted-foreground text-sm max-w-lg leading-relaxed"
            >
              Live status and latest updates on every active build. From solid
              rocket airframes to liquid engines and test infrastructure.
            </motion.p>
          </motion.div>
        </div>
      </section>
                    ...
                    <div className="flex items-center gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-2 mb-0.5">
                          ...
                          <span
                            className={`font-mono text-[10px] tracking-widest px-2 py-0.5 border rounded-full ${statusColor[p.status]}`}
                          >
                            {p.status}
                          </span>
                        </div>
                          ...
                          <div className="grid md:grid-cols-2 gap-6 md:gap-10">
                            <div>
                              ...
                              <div className="grid grid-cols-2 gap-x-6 gap-y-3">
                                {p.specs.map((s) => (
                                  <div key={s.label}>
                                    <div className="text-[10px] font-mono text-primary tracking-widest mb-0.5">
                                      {s.label}
                                    </div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-col gap-0">
                              {p.updates.map((u, j) => (
                                ...
                                >
                                  <span className="font-mono text-[10px] text-muted-foreground whitespace-nowrap pt-0.5 w-24 flex-shrink-0">
                                    {u.date}
                                  </span>
